    ...
    <div className="centered">
      ...
      <div>
        <div>
          ...
          <p>
            You can schedule an appointment by calling us, visiting our website,
            or using our online appointment booking system.
          </p>
        </div>
        <div>
          <h2>Can these products be delivered on my home?</h2>
          <p>
            The products are only for promotion and must be bought onsite on the
            grooming shop itself.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            appointments until the first one has been finished, if the customer
            wishes to schedule multiple appointments, the customer has to
            contact the administrators directly.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            haircutting, nail trimming, ear cleaning, and more. Please check our
        ...
        <div>
          ...
          <p>
            The duration varies based on the size and breed of your pet, as well
            as the services requested. On average, a grooming session takes 1 to
            3 hours.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>
            We use high-quality, pet-friendly grooming products. If your pet has
            allergies or specific product preferences, please let us know, and
