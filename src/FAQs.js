            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      We are able to groom Dogs and Cats all breeds, ages and
                      coats. We have a range of services that include,full
                      grooming, basic grooming and single services.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      We require pets to be up-to-date on core vaccinations.
                      Please provide proof of vaccinations, including rabies,
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      The duration varies based on the size and breed of your
                      pet, as well as the services requested. On average, a
                      grooming session takes 1 to 3 hours.
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      allow owners to stay in the grooming area. However, you
                      can discuss any concerns or specific instructions with our
                      groomers.
                    </div>
                  </div>
                </div>
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      Please inform us of any special needs or medical
                      conditions when scheduling your appointment. Our groomers
                      will take extra care to accommodate your pet's
                      requirements.
                    </div>
                  </div>
                </div>
              ...
              <div className="col-md-6">
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      We use high-quality, pet-friendly grooming products. If
                      your pet has allergies or specific product preferences,
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      Yes we do! We are located at 43a Agoncillo apartment
                      Severina Avenue, Paranaque City. Come by and join the
                      pack!
                    </div>
                  </div>
                </div>
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      Our groomers provide grooming services from 9am - 6pm
                      daily.
                    </div>
                  </div>
                </div>
              ...
              <div className="col-md-6">
                <div className="accordion-item">
                  <h2 className="accordion-header" id="headingFourteen">
                    ...
                    >
                      What do I have to inform the groomer before my
                      appointment?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div className="accordion-body">
                      Please inform our groomers of any illnesses, injury/wounds
                      or aggressive/unpredictable tendencies that your pet might
                      have, vaccinated or not.
                    </div>
                  </div>
                </div>
              </div>
